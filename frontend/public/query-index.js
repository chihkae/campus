...
//     CampusExplorer.buildQuery().then(function (result) {
//         CampusExplorer.sendQuery(result);
//     }).then( function (result2) {
//         CampusExplorer.renderResult(result2);
//     }).catch(function (err) {
//         CampusExplorer.renderResult(err.toString());
//     })
// });
